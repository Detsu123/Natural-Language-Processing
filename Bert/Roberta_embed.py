...
EMB_PATH = os.path.join(ART_DIR, "roberta_cls.npy")
Y_PATH   = os.path.join(ART_DIR, "roberta_labels.npy")

MODEL_NAME = "roberta-base"
MAX_LENGTH = 96
BATCH_SIZE = 16   # RoBERTa-base ≈ BERT-base
...
def main():
    ...
    all_cls = []
    with torch.no_grad():
        for batch in tqdm(loader, desc="RoBERTa embedding"):
            enc = tokenizer(
                batch,
                truncation=True,
                padding="max_length",
