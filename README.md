...
# []{#anchor-1}2. DATASET АШИГЛАГДСАН БАЙДАЛ
...
## []{#anchor-2}2.11 10 судалгааны ажлын харьцуулсан хүснэгт
...
# []{#anchor-3}3. EMBEDDING АРГУУД БОЛОН ОНОЛЫН ҮНДЭС
...
## []{#anchor-6}3.3 Word2Vec -- Skip-gram
...
## []{#anchor-11}3.8 SBERT (Sentence-BERT)
...
# []{#anchor-13}5. Фолдерийн бүтэц (Project Folder Structure)
...
## []{#anchor-16}7.2 СУДАЛГААНЫ ХЯЗГААРЛАЛТ 
